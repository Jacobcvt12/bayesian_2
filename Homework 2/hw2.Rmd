...
# s.2.n is the estimated residual variance under the least squares estimate
# for model n
...
**2**
Fit the regression model with interaction term to the FEV data. I prefer you use R directly and not jags.

**a)**
Using the posterior samples, estimate the posterior probability that the interaction term is positive and the posterior probability the interaction term is negative.
```{r p2a}
## NAIVE MODEL
...
**b)**
Based on these posterior probability estimates for the interaction term, what is your conclusion about the evidence for an interaction?
